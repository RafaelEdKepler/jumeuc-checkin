  ...
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center gap-6 px-6">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-semibold">Oh não... algo deu errado 😕</h2>

        <p className="text-muted-foreground max-w-md">
          Tivemos um problema ao carregar a lista de presentes. Isso pode ser
          apenas um erro temporário. Tente novamente em alguns instantes.
        </p>
      </div>
